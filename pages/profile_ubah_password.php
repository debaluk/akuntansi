...
$query=mysqli_query($con,"select * from tabel_operator where username='$_SESSION[username]'");
        ...
        <div class="modal-content">
            ...
            <form id="simpanvac" name="simpanvac"  action="" method="post" data-toggle="validator" role="form">
             	...
             	<div class="modal-body"> 
               		<input type="hidden" name="idlama" value="<?php echo $data[id_operator];?>">
                   <table width="100%" cellpadding="5" cellspacing="5">
					  ...
					  <tr>
					   ...
					   <tr>
					    <td>Password Lama</td>
					    <td><input class="form-control" type="password" id="pwdlama" name="pwdlama" required></td>
					  </tr>
					  <tr>
					    <td>Password Baru</td>
...
<script>
	...
	$("#simpanvac").on("submit", function(){
            $.ajax({
                type:"POST",
                url:"pages/data_operator_simpan_ubah_password.php",
