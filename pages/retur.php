    ...
    <div class="box-body">
		...
		<form id="simpanvac" name="simpanvac" method="post" action="">
		  <table width="80%">
		    ...
		    <tr height="40">
		      <td>Keterangan</td>
		      <td><input type="text" name="keterangan" id="keterangan" class="form-control" value="Retur Pembelian"  style="width:350px;" readonly required /></td>
			  <td width="100"></td>
			  <td>Tanggal Retur</td>
