...
insert  into `tabel_akun`(`id_akun`,`kode_akun`,`nama_akun`,`tipe_akun`,`tanggal_awal`,`awal_debet`,`awal_kredit`) values (34,'1-0101','Bank BRI','Aktiva','2018-07-01',10000000,0),(33,'1-0100','Kas','Aktiva','2018-07-01',3000000,0),(35,'1-0103','Persediaan Barang','Aktiva','2018-07-01',50000000,0),(36,'1-0104','Perlengkapan Toko','Aktiva','2018-07-01',2000000,0),(37,'1-0110','Peralatan Toko','Aktiva','2018-07-01',10000000,0),(38,'1-0111','Akm. Peny. Peralatan','Aktiva','2018-07-01',0,1000000),(39,'2-0200','Hutang Dagang','Kewajiban','2018-07-01',0,0),(40,'3-0300','Modal Bos','Modal','2018-07-01',71000000,0),(41,'4-0400','Penjualan Barang','Pendapatan','2018-07-01',0,0),(42,'5-0500','HPP','HPP','2018-07-01',0,0),(43,'6-0512','Biaya Listrik','Biaya','2018-07-01',0,0),(48,'6-0513','Gaji Pegawai','Biaya','2018-07-01',0,0);
...
insert  into `tabel_grafik`(`id`,`bulan`,`tahun`,`labarugi`) values (1,'January','2016',10),(2,'February','2016',12),(3,'Maret','2016',13),(4,'April','2016',18),(5,'May','2017',16),(6,'Juni','2016',14),(7,'July','2016',15),(8,'Agustus','2016',12),(9,'September','2016',19),(10,'Oktober','2016',12),(11,'November','2016',12),(12,'Desember','2016',20);
...
insert  into `tabel_jurnal`(`id_jurnal`,`nomor_faktur`,`tgl_jurnal`,`nomor_jurnal`,`referensi`,`keterangan`,`id_akun`,`debet`,`kredit`,`nama_user`) values (105,'-','2018-11-26','-','S0002','Saldo Awal',39,0,0,NULL),(104,'-','2018-11-26','-','S0001','Saldo Awal',39,0,0,NULL),(103,'-','2018-11-26','-','S002','Saldo Awal',39,0,0,NULL),(102,'-','2018-11-26','-','S0001','Saldo Awal',39,0,0,NULL),(109,'F001','2018-11-26','JU0001','S0002','Pembelian Kredit',39,0,9000000,'agus'),(108,'F001','2018-11-26','JU0001','S0002','Pembelian Kredit',35,9000000,0,NULL),(110,'F002','2018-11-26','JU0002','S0002','Pembelian Kredit',35,9000000,0,NULL),(111,'F002','2018-11-26','JU0002','S0002','Pembelian Kredit',39,0,9000000,'agus'),(112,'F001','2018-11-26','JU0003','S0002','Pembayaran Hutang',39,8000000,0,'agus'),(113,'F001','2018-11-26','JU0003','S0002','Pembayaran Hutang',33,0,8000000,'agus'),(114,'F002','2018-11-27','JU0004','-','Penjualan Barang',33,90000,0,'agus'),(115,'F002','2018-11-27','JU0004','-','Penjualan Barang',41,0,90000,'agus'),(116,'F002','2018-11-27','JU0004','-','Penjualan Barang',42,20000,0,'agus'),(117,'F002','2018-11-27','JU0004','-','Penjualan Barang',35,0,20000,'agus'),(118,'F001','2018-11-27','JU0005','S0002','Retur Pembelian',39,50000,0,'agus'),(119,'F001','2018-11-27','JU0005','S0002','Retur Pembelian',35,0,50000,'agus');
...
insert  into `tabel_keterangan`(`id_keterangan`,`keterangan`) values (1,'Penjualan Barang'),(2,'Biaya Listrik dan Air'),(3,'Pembelian Kredit'),(4,'Biaya Pegawai'),(5,'Retur Pembelian');
...
insert  into `tabel_rugi_laba`(`id_labarugi`,`id_akun`,`tipe_akun`,`tanggal`,`debet`,`kredit`) values (353,41,'Pendapatan',NULL,0,0),(354,42,'HPP',NULL,0,0),(355,43,'Biaya',NULL,0,0),(356,48,'Biaya',NULL,0,0);
...
insert  into `tabel_setup`(`id_setup`,`id_keterangan`,`id_akun`,`posisi_akun`) values (1,1,33,'Debet'),(2,1,41,'Kredit'),(3,1,42,'Debet'),(4,1,35,'Kredit'),(5,2,43,'Debet'),(6,2,33,'Kredit'),(7,3,35,'Debet'),(8,3,39,'Kredit'),(9,4,48,'Debet'),(10,4,33,'Kredit'),(11,5,39,'Debet'),(12,5,35,'Kredit');
...
insert  into `tabel_supplier`(`id_supplier`,`kode_supplier`,`nama_supplier`,`alamat_supplier`,`telepon_supplier`,`tanggal`,`saldo_awal`) values (3,'S0001','dsds','','dsd','2018-11-26',0),(4,'S0002','dsdsdsd','dsdsd','sdsdsdsd','2018-11-26',0);
